...
// Master
const uint8_t L_MAC_1[] = {0x30, 0xae, 0xa4, 0xff, 0x12, 0x00};
//OLD {0x78, 0x21, 0x84, 0xDD, 0xF2, 0x84};

// Slave
const uint8_t L_MAC_2[] = {0x30, 0xae, 0xa4, 0xf4, 0xfa, 0x00};
//OLD {0x78, 0x21, 0x84, 0xDE, 0x08, 0x58};
